...
{
public:
    void tracePhoton(PhotonMap &pmap, const Ray& r, const Scene& scene, Eigen::Vector3f lightColor, int depth);
    ...
    void tracePhotonCaustic(PhotonMap &pmap, const Ray &r, const Scene &scene, Eigen::Vector3f lightColor, int depth, bool flag);
};
